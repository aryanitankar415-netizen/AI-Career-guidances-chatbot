...
def get_db():  
    ...
    if DATABASE_URL:  
        ...
        class PostgresConnection:  
            """  
            Compatibility wrapper around psycopg2.  
            ...
            psycopg2 normally uses a cursor for execute(),  
            so this wrapper keeps the existing application  
            code compatible with PostgreSQL.  
            """  
