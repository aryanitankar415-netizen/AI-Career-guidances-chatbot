...
CAREERS = [
    {
        ...
        "tools": ["VS Code", "Git", "GitHub", "React", "Node.js", "Flask"],
        "beginner_projects": ["Personal Portfolio", "To-Do App", "Weather App"],
        "advanced_projects": ["E-commerce Website", "Real-time Chat Application", "Full-stack SaaS Application"],
    ...
    },
    {
        ...
        "tools": ["Git", "GitHub", "VS Code", "Docker", "Linux", "Cloud Platforms"],
        "beginner_projects": ["Calculator Application", "Student Management System", "Expense Tracker"],
        "advanced_projects": ["Scalable Web Platform", "Distributed System", "Microservices Application"],
    ...
    },
    {
        ...
        "icon": "📊",
        "demand": "High Demand",
        "skills": ["Excel", "SQL", "Python", "Pandas", "Statistics", "Power BI"],
        "salary": "₹3–12 LPA+",
        ...
        "beginner_projects": ["Sales Dashboard", "Movie Dataset Analysis", "Student Performance Analysis"],
        "advanced_projects": ["Business Intelligence Dashboard", "Customer Churn Analysis", "Automated Analytics Pipeline"],
    ...
    },
    {
        ...
        "icon": "📈",
        "demand": "Very High Demand",
        "skills": ["Python", "SQL", "Statistics", "Machine Learning", "Pandas", "Data Visualization"],
        "salary": "₹5–25 LPA+",
        ...
        "tools": ["Python", "Jupyter", "Pandas", "NumPy", "Scikit-learn", "Power BI"],
        "beginner_projects": ["House Price Prediction", "Customer Segmentation", "Sales Data Analysis"],
        "advanced_projects": ["Recommendation System", "Fraud Detection Model", "End-to-end ML Analytics Platform"],
    ...
    },
    {
        ...
        "icon": "🤖",
        "demand": "Very High Demand",
        "skills": ["Python", "Machine Learning", "Deep Learning", "SQL", "APIs", "MLOps"],
        "salary": "₹6–30 LPA+",
        ...
        "tools": ["Python", "Scikit-learn", "PyTorch", "TensorFlow", "Docker", "MLflow"],
        "beginner_projects": ["Spam Classifier", "House Price Predictor", "Image Classification Model"],
        "advanced_projects": ["Recommendation Engine", "Real-time Fraud Detection", "Production ML Platform"],
    ...
    },
    {
        ...
        "skills": ["Python", "LLMs", "Prompt Engineering", "RAG", "APIs", "Vector Databases"],
        "salary": "₹6–35 LPA+",
        ...
        "tools": ["Python", "Gemini API", "OpenAI APIs", "LangChain", "Vector Databases", "Docker"],
        "beginner_projects": ["AI Chatbot", "PDF Question Answering App", "AI Resume Assistant"],
        "advanced_projects": ["RAG Knowledge Platform", "AI Agent System", "Multi-modal AI Application"],
    ...
    },
    {
        ...
        "icon": "🧠",
        "demand": "Specialized",
        "skills": ["Python", "Mathematics", "Statistics", "Deep Learning", "Research", "Algorithms"],
        "salary": "₹8–40 LPA+",
        ...
        "tools": ["Python", "PyTorch", "TensorFlow", "Jupyter", "Linux", "GPU Computing"],
        "beginner_projects": ["Neural Network From Scratch", "Image Classifier", "ML Paper Reimplementation"],
        "advanced_projects": ["Novel ML Architecture", "LLM Research Project", "AI Research Publication"],
    ...
    },
    {
        ...
        "icon": "🔐",
        "demand": "High Demand",
        "skills": ["Networking", "Linux", "Security", "Python", "SIEM", "Incident Response"],
        "salary": "₹4–18 LPA+",
        ...
        "tools": ["Linux", "Wireshark", "SIEM", "Nmap", "Python", "Security Platforms"],
        "beginner_projects": ["Network Monitoring Lab", "Log Analysis Dashboard", "Security Awareness Website"],
        "advanced_projects": ["SOC Monitoring Platform", "Threat Detection System", "Security Automation Tool"],
    ...
    },
    {
        ...
        "icon": "🛡️",
        "demand": "High Demand",
        "skills": ["Networking", "Linux", "Web Security", "Python", "Security Testing", "OWASP"],
        "salary": "₹4–20 LPA+",
        ...
        "tools": ["Kali Linux", "Burp Suite", "Wireshark", "Nmap", "OWASP Tools", "Python"],
        "beginner_projects": ["Cybersecurity Lab", "Web Security Learning Lab", "Network Analysis Project"],
        "advanced_projects": ["Security Assessment Platform", "Vulnerability Management Dashboard", "Automated Security Testing Tool"],
    ...
    },
    {
        ...
        "icon": "☁️",
        "demand": "Very High Demand",
        "skills": ["Linux", "Networking", "AWS", "Azure", "Docker", "Terraform"],
        "salary": "₹5–22 LPA+",
        ...
        "tools": ["AWS", "Azure", "Docker", "Terraform", "Linux", "Kubernetes"],
        "beginner_projects": ["Cloud-hosted Portfolio", "Static Website Deployment", "Cloud Storage Application"],
        "advanced_projects": ["Scalable Cloud Architecture", "Serverless Application", "Multi-service Cloud Platform"],
    ...
    },
    {
        ...
        "tools": ["GitHub Actions", "Docker", "Kubernetes", "Jenkins", "Terraform", "AWS"],
        "beginner_projects": ["CI/CD Pipeline", "Dockerized Flask App", "Automated Deployment"],
        "advanced_projects": ["Kubernetes Platform", "Infrastructure-as-Code System", "Complete DevOps Pipeline"],
    ...
    },
    {
        ...
        "tools": ["Figma", "FigJam", "Adobe XD", "Photoshop", "Design Systems"],
        "beginner_projects": ["Mobile App Redesign", "Landing Page Design", "Portfolio Website Design"],
        "advanced_projects": ["Complete Product Design", "Design System", "UX Research Case Study"],
    ...
    },
    {
        ...
        "icon": "📱",
        "demand": "High Demand",
        "skills": ["Flutter", "React Native", "Kotlin", "Swift", "APIs", "UI Design"],
        "salary": "₹4–18 LPA+",
        ...
        "tools": ["Flutter", "Dart", "Android Studio", "Firebase", "React Native"],
        "beginner_projects": ["To-Do Mobile App", "Weather App", "Expense Tracker"],
        "advanced_projects": ["Social Media App", "Food Delivery App", "Real-time Collaboration App"],
    ...
    },
    {
        ...
        "icon": "🗄️",
        "demand": "High Demand",
        "skills": ["SQL", "Database Design", "Linux", "Backup", "Security", "Performance"],
        "salary": "₹4–18 LPA+",
        ...
        "tools": ["MySQL", "PostgreSQL", "MongoDB", "SQL Server", "Linux"],
        "beginner_projects": ["Student Database", "Library Management Database", "SQL Reporting System"],
        "advanced_projects": ["High Availability Database", "Database Monitoring System", "Backup and Recovery Platform"],
    ...
    },
    {
        ...
        "icon": "⛓️",
        "demand": "Growing",
        "skills": ["JavaScript", "Solidity", "Cryptography", "Smart Contracts", "Web3", "Blockchain"],
        "salary": "₹5–25 LPA+",
        ...
        "tools": ["Solidity", "Ethereum", "Hardhat", "JavaScript", "Web3 Libraries"],
        "beginner_projects": ["Simple Smart Contract", "Blockchain Explorer UI", "Decentralized Voting Demo"],
        "advanced_projects": ["DeFi Application", "NFT Platform", "Decentralized Application"],
    ...
    },
    {
        ...
        "icon": "🎮",
        "demand": "Growing",
        "skills": ["C#", "C++", "Game Design", "3D Math", "Unity", "Unreal Engine"],
        "salary": "₹3–18 LPA+",
        ...
        "beginner_projects": ["2D Platformer", "Puzzle Game", "Simple Mobile Game"],
        "advanced_projects": ["3D Multiplayer Game", "Open World Prototype", "Game AI System"],
    ...
    },
    {
        ...
        "icon": "🚀",
        "demand": "High Demand",
        "skills": ["Product Strategy", "Communication", "Analytics", "UX", "Agile", "Leadership"],
        "salary": "₹6–30 LPA+",
        ...
        "tools": ["Jira", "Notion", "Figma", "Google Analytics", "Product Analytics Tools"],
        "beginner_projects": ["Product Case Study", "App Feature Analysis", "Product Roadmap"],
        "advanced_projects": ["Complete Product Strategy", "Growth Experiment Plan", "Product Launch Case Study"],
...
def db_sql(query):
    """
    Keep SQL readable with ? placeholders in the source.
    PostgreSQL requires %s, while SQLite uses ?.
    """
    if is_postgres():
...
def get_db():
    ...
    Local development:
        SQLite fallback using career_guidance.db.
    """
...
def init_db():
    ...
    try:
        if is_postgres():
            ...
            # Compatibility with an older local SQLite database.
...
# On Vercel, app.py is imported rather than executed as __main__.
# Therefore database initialization must happen during import.
# Errors are logged instead of preventing the Flask app from loading.
try:
    init_db()
except Exception as db_error:
    print("Database initialization warning:", db_error)
...
def login():
    ...
    if request.method == "POST":
        ...
        # Works for both psycopg dict_row and sqlite3.Row.
        if isinstance(user, dict):
            ...
            keys = user.keys()
            stored_password = (
                user["password"] if "password" in keys else None
            )
            if not stored_password and "password_hash" in keys:
...
def api_chat():
    ...
    try:
        ...
        conn.rollback()
        print("Chat database error:", exc)

        return jsonify({
            "error": "Unable to save chat right now.",
        }), 500
...
if __name__ == "__main__":
    ...
    # Local SQLite database is initialized here as well.
    try:
        init_db()
    except Exception as exc:
